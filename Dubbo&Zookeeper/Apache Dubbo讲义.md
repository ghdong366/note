...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/单体架构.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/垂直架构.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/SOA架构.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/微服务架构.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo架构.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/文件树形图.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Zookeeper树形目录.png)
...
public class HelloController {
    ...
    public String say(String name){
        String user = helloService.sayHello(name);
...
">
    ...
    <context:component-scan base-package="vip.george366.controller"></context:component-scan>
    <dubbo:application name="dubbo_consumer"></dubbo:application>
<!--    <dubbo:registry address="zookeeper://101.34.207.166:2181"></dubbo:registry>-->

    <dubbo:registry address="zookeeper://127.0.0.1:2181"></dubbo:registry>
    <dubbo:annotation package="vip.george366.controller"></dubbo:annotation>
</beans>
~~~
...
（3）修改WEB-INF下的==dubbo.properties==文件，注意dubbo.registry.address对应的值需要对应当前使用的Zookeeper的ip地址和端口号
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo管理控制台1.png)

（2）启动服务提供者工程和服务消费者工程，可以在查看到对应的信息

![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo管理控制台2.png)

![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo管理控制台3.png)

![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo管理控制台4.png)

![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo管理控制台5.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/解决Dubbo无法发布被事务代理的Service问题(报错).png)

上面的错误为没有可用的服务提供者

查看dubbo管理控制台发现服务并没有发布，如下：

![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/解决Dubbo无法发布被事务代理的Service问题2.png)



可以通过断点调试的方式查看Dubbo执行过程，Dubbo通过AnnotationBean的postProcessAfterInitialization方法进行处理

![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo通过AnnotationBean的postProcessAfterInitialization方法进行处理.png)



![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo通过AnnotationBean的postProcessAfterInitialization方法进行处理2.png)
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/Dubbo通过AnnotationBean的postProcessAfterInitialization方法进行处理3.png)（2)修改HelloServiceImpl类，在Service注解中加入`interfaceClass`属性，值为HelloService.class，作用是指定服务的接口类型
...
![](https://geda-1302176138.cos.ap-nanjing.myqcloud.com/img/解决Dubbo无法发布被事务代理的Service问题（控制端）.png)